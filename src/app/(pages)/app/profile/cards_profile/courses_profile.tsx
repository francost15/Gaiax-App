      ...
      <CardContent className="p-6">
        <div className="space-y-6">
          {completedCourses.map((course) => (
            <div
              key={course.id}
              className="rounded-xl bg-gray-50 dark:bg-neutral-800 p-4  shadow-sm transition-all duration-300 hover:shadow-md"
            >
              <div className="flex justify-between items-center mb-2">
                ...
                >
                  <ChevronRight
                    className={`h-5 w-5 text-[#6366F1] transition-transform ${
              ...
              {expandedCourse === course.id && (
                <div
                  ...
                  className="mt-4 pl-4 border-l-2 border-[#6366F1]"
                >
