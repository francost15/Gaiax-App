import { LogOut, Settings, User, Bell, HelpCircle, Moon, Sun } from 'lucide-react'
import {   DropdownMenu, DropdownMenuContent, DropdownMenuItem,DropdownMenuLabel, 
    DropdownMenuSeparator,DropdownMenuTrigger,DropdownMenuGroup,DropdownMenuSub,
    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        ...
        className="transition-opacity cursor-pointer hover:opacity-80">
          <AvatarFallback  className="text-white bg-primaryper">FA</AvatarFallback>
        </Avatar>
      </DropdownMenuTrigger>
      <DropdownMenuContent align="end" className="w-64 p-2 bg-white border border-gray-200 rounded-lg shadow-lg dark:bg-neutral-800 dark:border-neutral-700">
        <DropdownMenuLabel className="p-4 mb-2 rounded-md bg-gray-50 dark:bg-neutral-900">
          <div className="flex items-center space-x-3">
            ...
            <div className="flex flex-col">
              <p className="text-sm font-medium text-gray-900 dark:text-gray-100">Franco Alessandro</p>
              <p className="text-xs text-gray-500 dark:text-gray-400">franco@example.com</p>
              <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">Desarrollador</p>
            </div>
          </div>
        </DropdownMenuLabel>
        <DropdownMenuGroup>
          ...
          <DropdownMenuItem className="rounded-md focus:bg-gray-100 dark:focus:bg-neutral-700">
            <Bell className="w-4 h-4 mr-2 text-primaryper" />
        ...
        <DropdownMenuGroup>
          <DropdownMenuSub>
            ...
            <DropdownMenuSubContent className="bg-white border border-gray-200 dark:bg-neutral-800 dark:border-neutral-700">
              <DropdownMenuItem onClick={() => setTheme("light")} className="rounded-md focus:bg-gray-100 dark:focus:bg-neutral-700">
                <Sun className="w-4 h-4 mr-2 text-primaryper" />
                <span>Claro</span>
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => setTheme("dark")} className="rounded-md focus:bg-gray-100 dark:focus:bg-neutral-700">
                <Moon className="w-4 h-4 mr-2 text-primaryper" />
                <span>Oscuro</span>
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => setTheme("system")} className="rounded-md focus:bg-gray-100 dark:focus:bg-neutral-700">
                <Settings className="w-4 h-4 mr-2 text-primaryper" />
                <span>Sistema</span>
              </DropdownMenuItem>
